...
Neste repositório contém uma pagina HTML que faz uso das tags section, article, p, a e img. (This repository contains an HTML page that makes use of the section, article, p, a and img tags.)
